...
public class SavingsAccount extends BankAccount_Test {
	...
	public SavingsAccount(double interestRate1) {
		super();
	...
	public static  void computeInterest() throws IOException {
	...
	if (valid) {
		...
		//interestRate1=3;
			...
			interestBalance = (acc1.getAccBalance() * 3 / 100) + acc1.getAccBalance();
